...
class ApiEndpoints {
  ...
  /// Get cycle data
  static Future<ApiResponse<List<dynamic>>> getCycleData({
    String? startDate,
    String? endDate,
    int? limit,
  }) async {
    ...
    return _client.get<List<dynamic>>('/cycles?$queryString');
  }
  ...
  static Future<ApiResponse<List<dynamic>>> getSurveyQuestions({
    String? category,
  }) async {
    final endpoint = category != null
        ? '/surveys?category=$category'
        : '/surveys';
    return _client.get<List<dynamic>>(endpoint);
  }
  ...
  static Future<ApiResponse<Map<String, dynamic>>> submitSurveyResponse({
    ...
    return _client.post<Map<String, dynamic>>(
      ...
      body: {'survey_id': surveyId, 'responses': responses},
    );
  }
  ...
  /// Get community posts
  static Future<ApiResponse<List<dynamic>>> getCommunityPosts({
    int? page,
    int? limit,
    String? category,
  }) async {
    ...
    return _client.get<List<dynamic>>('/community/posts?$queryString');
  }
  ...
  /// Get notifications
  static Future<ApiResponse<List<dynamic>>> getNotifications({
    bool? read,
    int? limit,
  }) async {
    final queryParams = <String, String>{};
    ...
    return _client.get<List<dynamic>>('/notifications?$queryString');
  }
  ...
  /// Dispose API client
  static void dispose() {
    // Note: HttpClient doesn't need explicit disposal
  }
}
